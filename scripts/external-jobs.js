...
const JOBS = [
  ...submoduleJobs('2f85_cpp', { repoUrl: 'https://github.com/robotiq/grippers', branch: 'main' }, [
    ...
    { from: 'README.md', to: 'drivers/Adaptive grippers/SDK/C++/_readme.md' },
    ...
    {
      from: 'docs',
      to: 'drivers/Adaptive grippers/SDK/C++/docs',
      docSnippetsCheck: {
    ...
    // never hand-authors or curates content on top.
    {
      ...
      to: 'drivers/Adaptive grippers/SDK/C++/API',
      exclude: [
  ...
  ...submoduleJobs('tactile_sensors', { repoUrl: 'https://github.com/robotiq/tactile_sensors', branch: 'main' }, [
    ...
    { from: 'sdk_cpp/README.md', to: 'drivers/Tactile Sensor/SDK/C++/_readme.md' },
    // TSF 85 Python driver README
    { from: 'sensor_quickstart/README.md', to: 'drivers/Tactile Sensor/SDK/Python/_readme.md' },
